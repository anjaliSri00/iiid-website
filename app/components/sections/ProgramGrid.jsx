    ...
    <>
     <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {programs.map((program) => (
            ...
            >
              <Card className="hover:shadow-xl transition-all duration-300 border border-gray-200 flex flex-col h-full cursor-pointer">
                <Card.Body className="p-5 md:p-6 flex flex-col h-full">
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="w-full montserrat-500 bg-transparent border border-red-600 text-red-600 px-4 py-2 rounded-md hover:bg-red-600 hover:text-white transition-all duration-300 flex items-center justify-between group">
