  ...
  return (
    <section id="home" className="relative w-full text-white min-h-150">
      ...
      <div className="absolute inset-0 z-20 flex items-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-sm md:max-w-md lg:max-w-lg bg-orange-50/70 text-black backdrop-blur-sm p-6 md:p-8 transition-all duration-500">
          ...
          <button className="border-2 border-black text-gray-800 px-6 md:px-8 py-3 hover:text-gray-900 transition-all duration-300 font-medium">
            {activeSlide.ctaText}
          </button>
        </div>
      </div>
