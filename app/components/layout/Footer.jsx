...
const currentYear = new Date().getFullYear()
  ...
  return (
    <footer className="max-w-screen-3xl w-full bg-[#0A0A0A] border-t border-[#CC0000]/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          >
            ...
            {/* <div className="flex space-x-3 pt-2">
              <Link 
                href="#" 
                className="w-10 h-10 bg-[#CC0000]/10 text-[#CC0000] rounded-lg flex items-center justify-center hover:bg-[#CC0000] hover:text-white transition-all duration-300 border border-[#CC0000]/20"
              >
                <FaFacebook size={18} />
              </Link>
              <Link 
          ...
          <motion.div 
            ...
            className="space-y-4"
          >
            <h4 className="text-lg font-semibold text-white relative inline-block pb-2 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-12 after:h-0.5 after:bg-[#CC0000]">
              Quick Links
            </h4>
            <ul className="space-y-3">
              <li>
                <Link href="/" className="text-gray-400 hover:text-[#CC0000] transition-colors flex items-center group">
                  <ChevronRight size={16} className="mr-2 text-[#CC0000] group-hover:translate-x-1 transition-transform" />
                  Home
                </Link>
              </li>
              <li>
                <Link href="/apply-online" className="text-gray-400 hover:text-[#CC0000] transition-colors flex items-center group">
                  <ChevronRight size={16} className="mr-2 text-[#CC0000] group-hover:translate-x-1 transition-transform" />
                  Apply Online
                </Link>
              </li>
              <li>
                <Link href="/about-us" className="text-gray-400 hover:text-[#CC0000] transition-colors flex items-center group">
                  <ChevronRight size={16} className="mr-2 text-[#CC0000] group-hover:translate-x-1 transition-transform" />
                  About IIID
                </Link>
              </li>
          ...
          >
            ...
            <ul className="space-y-3">
              <li>
                <a href="#programs" className="text-gray-400 hover:text-[#CC0000] transition-colors group flex items-center gap-2">
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 group">
                <div className="w-9 h-9 bg-[#CC0000]/10 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-[#CC0000] transition-colors border border-[#CC0000]/20">
                  <MailIcon size={16} className="text-[#CC0000] group-hover:text-white transition-colors" />
                </div>
                <Link 
                  href="mailto:support@iiid.institute" 
                  className="text-gray-400 hover:text-[#CC0000] transition-colors text-sm"
                >
                  support@iiid.institute
                </Link>
              </div>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-[#CC0000]/20 bg-[#0A0A0A]">
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            {/* Copyright */}
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6 text-sm">
              ...
              <span className="text-[#CC0000]/30">|</span>
              <a href="#" className="text-gray-400 hover:text-[#CC0000] transition-colors">
                Terms of Service
              </a>
              <span className="text-[#CC0000]/30">|</span>
